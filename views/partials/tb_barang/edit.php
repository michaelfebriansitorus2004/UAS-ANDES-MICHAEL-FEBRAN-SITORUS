                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-supplier"  value="<?php  echo $data['supplier']; ?>" type="text" placeholder="Enter Supplier"  required="" name="supplier"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-status_barang"  value="<?php  echo $data['status_barang']; ?>" type="text" placeholder="Enter Status Barang"  required="" name="status_barang"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
