                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="waktu_beli">Waktu Beli <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <input id="ctrl-waktu_beli" class="form-control datepicker  datepicker" required="" value="<?php  echo $this->set_field_value('waktu_beli',""); ?>" type="datetime"  name="waktu_beli" placeholder="Enter Waktu Beli" data-enable-time="true" data-min-date="" data-max-date="" data-date-format="Y-m-d H:i:S" data-alt-format="F j, Y - H:i" data-inline="false" data-no-calendar="false" data-mode="single" /> 
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-status_barang"  value="<?php  echo $this->set_field_value('status_barang',""); ?>" type="text" placeholder="Enter Status Barang"  required="" name="status_barang"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
